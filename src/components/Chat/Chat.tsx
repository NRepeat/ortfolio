    ...
    <Card className="w-full max-w-[400px]">
      <CardHeader className="flex flex-row items-center justify-between">
        <div className="flex flex-row  items-center">
          {/* <Avatar className="w-16 h-16" onClick={logout}>
            <AvatarImage
          ...
          <div className="inline-flex gap-1 flex-col ">
            ...
            <h3 className="text-md text-muted-foreground h-full">
              {chatState.chatRoom}
            </h3>
          </div>
        </div>
        <div className="flex items-start justify-start">
          <CircleX onClick={logout} className="fill-red-700/60" />
        </div>
      </CardHeader>

      <CardContent className="h-[400px] flex-col flex gap-3">
        {messages &&
